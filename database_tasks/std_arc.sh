...
count=`ssh oracle@192.168.25.167 ls -1 $ORACLE_BASE/fast_recovery_area/$sid_dir/archivelog/$date_dir/ | wc -l`
for ((i=1; i<=$count; i++));do
	...
	if [ $? -eq 0 ];then
       		 scp  oracle@192.168.25.167:$ORACLE_BASE/fast_recovery_area/$sid_dir/archivelog/$date_dir/o1_mf_1_${req_arc}* oracle@192.168.25.161:/home/oracle/carrot
	fi
